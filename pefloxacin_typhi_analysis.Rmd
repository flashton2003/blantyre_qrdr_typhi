...
combined_cases_by_month <- combine_cases_by_month(tyvac_cases_by_month, strataa_cases_by_month, cases_start, cases_end)
...
combined_prescrip_by_month <- left_join(combined_prescrip_by_month, tyvac_presc_by_month, by = 'Month')
