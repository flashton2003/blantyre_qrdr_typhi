...
Data has been pulled in from various sources and cleaned using `pefloxacin_typhi_data_cleaning.Rmd`. The clean data has been saved as `r data/cases_bc_qrdr_prescrip_microconf_handle`.
